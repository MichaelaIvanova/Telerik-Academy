...
describe('Test for Modules and Patterns in JavaScript', function () {
    ...
    describe('Pushing Exam Results', function () {
        ...
        it('expect getTopStudents to return an array of the listed students (no students)', function () {
            var jsoop = Object.create(Course)
                .init(getValidTitle(), [getValidTitle()]);
            expect(jsoop.getTopStudents()).to.be.eql([]);
        });
        it('expect getTopStudents to return an array of the listed top 10 students if students are more than 10', function () {
            var jsoop = Object.create(Course)
                .init(getValidTitle(), [getValidTitle()]);
            expect(jsoop.getTopStudents().length).to.be.eql(10);
        });
